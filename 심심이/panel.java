...
public class panel {
    public static void main(String[] args) {
        ...
        ArrayList<commentClass> CC= new ArrayList<>();
            ...
            if (sca.equals("list")) {
                ...
                for (int a1 = 0; a1 < titles.size(); a1++) {
                    if (boardnum.get(a1) == sca66) {
                        ...
                        for(String comment : CC.get(a1).comment)
                ...
                while (true) {
                    ...
                    if (sca53.equals("1")) {
                        ...
                        System.out.println("수정할 댓글 번호를 입력해");

                        System.out.println("수정할 댓글 내용을 입력해주세요");
                        String scab2 = sc.nextLine();
//                        for (int b3 = 0; b3 < boardnum.size(); b3++) {
